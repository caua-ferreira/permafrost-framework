...
def _load():
    from permafrost_v4 import freeze as pf_freeze, thaw as pf_thaw, audit as pf_audit
    from permafrost_v4 import CODEC_LZMA2, CODEC_ZSTD, QUANT_NONE, QUANT_MEDIUM
...
def verify(
    ...
    from permafrost_v4 import MAGIC, EOF_MAGIC, _sha256, _read_header, _read_sparse_index
